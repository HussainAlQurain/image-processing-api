...
const resizeImg = (file, width, height) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getImage = (imageName, width, height) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const filePath = Path.join(__dirname, `../images/processed/edited_${width}x${height}_` +
            imageName +
            '.jpg');
        try {
            ...
            yield resizeImg(Path.join(__dirname, '../images/' + imageName + '.jpg'), width, height);
            return filePath;
        }
    }
    catch (err) {
